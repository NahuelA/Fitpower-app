...
public class Nutricionista {
        ...
        public Nutricionista(String nombre, String apellido, String dni, int cupo) {
            this.nombre = nombre;
        ...
        public String toString() {
            return "Nutricionista { Nombre: " + nombre + ", Apellido: " + apellido + ", DNI: " + dni + ", Cupo: " + cupo + ", Disponible: " + disponible + " }";
        }
    }
